...
## vision
x73 es una plataforma que te permite crear aplicaciones web con prompts
todo el scaling es manejado por nosotros con las integraciones que todos nesesitan
(resend, ai api keys, etc) es barato por fly.io
puedes usar tu propia api key para hacer los websites, incluido claude code sub
si no tienes puedes elegir entre todos los modelos, al precio de %2+
es usage based pricing, pagas por que construirs y usas
todos los meses se deducta $1 del balance por mantenimiento

ejemplo:
10 llamadas a claude: $2
deploy de app: $0.50
quieres mas llamadas y deploys?
agrega a tu balance y estara todo bien

app builder + claude services + usage based pricing
ahora todos tienen subscription models que son super caros
